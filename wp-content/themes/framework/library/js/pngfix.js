...
DD_belatedPNG.fix( '.header_left img ' );
DD_belatedPNG.fix( '.header_cart' );
DD_belatedPNG.fix( '.featured_pro a img' );
DD_belatedPNG.fix( '.coda-nav-left a' );
DD_belatedPNG.fix( '.coda-nav-right a' );
DD_belatedPNG.fix( '#main_bottom' );
DD_belatedPNG.fix( 'a.previous' );
DD_belatedPNG.fix( 'a.next' );
DD_belatedPNG.fix( '.logo' );
DD_belatedPNG.fix( '#content ul.display li img' );
DD_belatedPNG.fix( '.shoppingcart_box' );\
