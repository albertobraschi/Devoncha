...
<li class="comment wrap threaded" id="comment-<?php comment_ID() ?>">
		    ...
		    <div class="meta-left">
  					<?php echo get_avatar( $comment, 48, $template_path . ''.get_bloginfo('template_directory').'/images/gravatar.png' ); ?> 
 			</div>
			    
			<div class="text-right <?php if (1 == $comment->user_id) $oddcomment = "authcomment"; echo $oddcomment; ?>">
             	<p class="authorcomment"> <strong><?php comment_author_link() ?></strong> <span> at <?php comment_date('M d, Y h:i:s'); ?> </span> </p>
 				<?php comment_text() ?>
