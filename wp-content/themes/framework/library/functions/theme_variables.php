<?php
$themename = 'eComFramework';
$shortname = "ptthemes";
$current_theme = get_option('current_theme');
$template = get_option('template');
$stylesheet = get_option('stylesheet');
if(CHILDTEMPLATEPATH  && file_exists(CHILDTEMPLATEPATH . '/custom.css'))
{
	$customstylesheet = "/themes/$stylesheet/custom.css&theme=$current_theme&dir=style";
}else
{
	$customstylesheet = "/themes/$stylesheet/custom.css&theme=$current_theme&dir=style";
}

$customcssurl = "".trailingslashit( get_bloginfo('url') )."wp-admin/theme-editor.php?file=$customstylesheet";
