...
if($_GET['ptype']=='prd' || $_POST || $editproduct==1){
	...
	$meta_boxes['att6title'] = 
	array(
		"name" => "att6title",
		"title" => "Attribute 6 Title",
		"type" 		=> "text",
		"default" 	=> "",
		"tabindex"	=>	'2',
		"description" => "Product Attribute title 6");
	
	$meta_boxes['attribute6'] = 
	array(
		"name" => "attribute6",
		"title" => "Attribute 6 Value",
		"type" 		=> "select",
		"tabindex"	=>	'2',
		"default" 	=> "attribute6",
		"description" => "Product is available in various Colors. <b>Please press <u>Set Changes</u> button to get your changes effected.</b>'");
	
	$meta_boxes['attribute6_stock'] = 
	array(
		"name" => "attribute6_stock",
		"title" => "",
		"type" 		=> "hidden",
		"default" 	=> "",
		"tabindex"	=>	'2',
	...
	$meta_boxes['att7title'] = 
	array(
		"name" => "att7title",
		"title" => "Attribute 7 Title",
		"type" 		=> "text",
		"default" 	=> "",
		"tabindex"	=>	'2',
		"description" => "Product Attribute title 7");
	
	$meta_boxes['attribute7'] = 
	array(
		"name" => "attribute7",
		"title" => "Attribute 7 Value",
		"type" 		=> "select",
		"tabindex"	=>	'2',
		"default" 	=> "attribute7",
		"description" => "Product is available in various Colors. <b>Please press <u>Set Changes</u> button to get your changes effected.</b>'");
	
	$meta_boxes['attribute7_stock'] = 
	array(
		"name" => "attribute7_stock",
		"title" => "",
		"type" 		=> "hidden",
		"default" 	=> "",
		"tabindex"	=>	'2',
...
$meta_boxes['att8title'] = 
	array(
		"name" => "att8title",
		"title" => "Attribute 8 Title",
		"type" 		=> "text",
		"default" 	=> "",
		"tabindex"	=>	'2',
		"description" => "Product Attribute title 8");
	
	$meta_boxes['attribute8'] = 
	array(
		"name" => "attribute8",
		"title" => "Attribute 8 Value",
		"type" 		=> "select",
		"tabindex"	=>	'2',
		"default" 	=> "attribute8",
		"description" => "Product is available in various Colors. <b>Please press <u>Set Changes</u> button to get your changes effected.</b>'");
	
	$meta_boxes['attribute8_stock'] = 
	array(
		"name" => "attribute8_stock",
		"title" => "",
		"type" 		=> "hidden",
		"default" 	=> "",
		"tabindex"	=>	'2',
...
$meta_boxes['att9title'] = 
	array(
		"name" => "att5title",
		"title" => "Attribute 9 Title",
		"type" 		=> "text",
		"default" 	=> "",
		"tabindex"	=>	'2',
		"description" => "Product Attribute title 9");
	
	$meta_boxes['attribute9'] = 
	array(
		"name" => "attribute9",
		"title" => "Attribute 9 Value",
		"type" 		=> "select",
		"tabindex"	=>	'2',
		"default" 	=> "attribute9",
		"description" => "Product is available in various Colors. <b>Please press <u>Set Changes</u> button to get your changes effected.</b>'");
	
	$meta_boxes['attribute9_stock'] = 
	array(
		"name" => "attribute9_stock",
		"title" => "",
		"type" 		=> "hidden",
		"default" 	=> "",
		"tabindex"	=>	'2',
...
$meta_boxes['att10title'] = 
	array(
		"name" => "att10title",
		"title" => "Attribute 10 Title",
		"type" 		=> "text",
		"default" 	=> "",
		"tabindex"	=>	'2',
		"description" => "Product Attribute title 10");
	
	$meta_boxes['attribute10'] = 
	array(
		"name" => "attribute10",
		"title" => "Attribute 10 Value",
		"type" 		=> "select",
		"tabindex"	=>	'2',
		"default" 	=> "attribute10",
		"description" => "Product is available in various Colors. <b>Please press <u>Set Changes</u> button to get your changes effected.</b>'");
	
	$meta_boxes['attribute10_stock'] = 
	array(
		"name" => "attribute10_stock",
		"title" => "",
		"type" 		=> "hidden",
		"default" 	=> "",
		"tabindex"	=>	'2',
...
function my_shoppingcart_summary() 
{
	...
	$processingOrders_currentmonth = ($currentMonthOrders['processing']);
	$processingOrders = ($AllOrders['processing']);
	$approveOrders_currentmonth = ($currentMonthOrders['approve']);
	$approveOrders = ($AllOrders['approve']);
	$rejectOrders_currentmonth = ($currentMonthOrders['reject']);
	$rejectOrders = ($AllOrders['reject']);
	$cancelOrders_currentmonth = ($currentMonthOrders['cancel']);
	$cancelOrders = ($AllOrders['cancel']);
	$shippingOrders_currentmonth = ($currentMonthOrders['shipping']);
	$shippingOrders = ($AllOrders['shipping']);
	$deliveredOrders_currentmonth = ($currentMonthOrders['delivered']);
	$deliveredOrders = ($AllOrders['delivered']);
	foreach($currentMonthOrders as $key=>$value)
	{
		$totalOrders = $totalOrders + ($currentMonthOrders[$key]);
	}
	foreach($AllOrders as $key1=>$value1)
	{
		$totalOrders_currenmonth = $totalOrders_currenmonth + ($AllOrders[$key1]);
	}
	$currentmonth = date('m');
...
<table border="0" cellspacing="8" cellpadding="0">
  ...
  <tr>
    ...
    <td align="center"><?php if($totalOrders){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&month=$currentmonth");?>">
      <?php }?>
    ...
    <td align="center"><?php if($totalOrders_currenmonth){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders");?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($processingOrders_currentmonth){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&month=$currentmonth&srch_status=pending");?>">
      <?php }?>
    ...
    <td align="center"><?php if($processingOrders){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&srch_status=pending");?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($approveOrders_currentmonth){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&month=$currentmonth&srch_status=approve");?>">
      <?php }?>
      ...
      <?php }?></td>
    <td align="center"><?php if($approveOrders_currentmonth){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&srch_status=approve");?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($rejectOrders_currentmonth){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&month=$currentmonth&srch_status=reject");?>">
      <?php }?>
    ...
    <td align="center"><?php if($rejectOrders){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&srch_status=reject");?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($cancelOrders_currentmonth){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&month=$currentmonth&srch_status=cancel");?>">
      <?php }?>
    ...
    <td align="center"><?php if($cancelOrders){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&srch_status=cancel");?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($shippingOrders_currentmonth){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&month=$currentmonth&srch_status=shipping");?>">
      <?php }?>
    ...
    <td align="center"><?php if($shippingOrders){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&srch_status=shipping");?>">
      <?php }?>
  ...
  <tr>
    ...
    <td align="center"><?php if($deliveredOrders_currentmonth){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&month=$currentmonth&srch_status=delivered");?>">
      <?php }?>
    ...
    <td align="center"><?php if($deliveredOrders){?>
      <a href="<?php echo site_url("/wp-admin/admin.php?page=manageorders&srch_status=delivered");?>">
      <?php }?>
...
?>
  <tr>
    <td ><a href="<?php echo site_url('/wp-admin/admin.php?page=manageorders&oid='.$order_info->oid);?>"><?php echo $order_info->oid;?></a></td>
