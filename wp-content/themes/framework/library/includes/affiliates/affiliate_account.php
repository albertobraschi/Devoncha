...
<table width="100%" class="table">
    <tr>
	    <td colspan="2" class="title"><?php _e(AFFILIATE_INFO_PAGE_TITLE); ?> </td>
    </tr>
    <tr>
        <td class="row1" ><?php _e(AFFILIATE_CODE_TEXT); ?> : </td>
        <td class="row1" ><?php echo $user_id;?></td>
    </tr>
        <tr>
        <td class="row1" ><?php _e(PAYPAL_ACCOUNT_TEXT); ?> : </td>
        <td class="row1" >
        ...
        &nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" onclick="aff_payment()";><strong><?php _e(CHANGE_TEXT);?></strong></a>
    ...
    <td><a href="javascript:void(0)" onclick="ajax_set_affiliate_account();" class="highlight_button fr" ><?php _e(SUBMIT_BUTTON_TEXT);?></a></td>
    </tr></table>
    </form>
    </div>
        </td>
...
<table width="100%" class="table">
    <tr>
	    <td colspan="2" class="title"><?php _e(SALE_SUMMARY); ?> </td>
    </tr>
    <tr>
        <td class="row1" ><?php _e(NUMBER_OF_TRANSACTIONS_TEXT);?> : </td>
        <td class="row1" ><?php echo number_format($user_total_array[2]);?></td>
	</tr>
    <tr>
        <td class="row1" ><?php _e(ITEM_SOLD_TEXT);?> : </td>
        <td class="row1" ><?php echo number_format($user_total_array[3]);?></td>
	</tr>
    <tr>
        <td class="row1" ><?php _e(TOTAL_SALES_AMOUNT_TEXT);?> : </td>
        <td class="row1" ><?php echo $General->get_amount_format($user_total_array[1],0).' '.$General->get_currency_code();?></td>
	</tr>
    <tr>
        <td class="row1" ><?php _e(TOTAL_EARNING_TEXT);?> : </td>
	...
	if($affiliate_links)
	{
		...
		?>
            <tr>
                ...
                $link =  site_url().'?ptype=account&lkey='.$lkey.'&aid='.$user_id; ?>
