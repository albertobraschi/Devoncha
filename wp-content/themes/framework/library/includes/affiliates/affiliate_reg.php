...
?>
		<p><span class="forgot_password fr"> <?php _e(ALREADY_MEMBER_TEXT);?><a href="<?php echo site_url();?>/?ptype=affiliate"><?php _e(ALREADY_MEMBER_LINK);?></a></span></p>
        <div class="clearfix"></div>
         <form name="registerform" id="registerform" action="<?php echo site_url().'/?ptype=affiliate&amp;action=register&amp;type=reg';//echo site_url('wp-login.php?action=register', 'login_post') ?>" method="post">
        <?php
