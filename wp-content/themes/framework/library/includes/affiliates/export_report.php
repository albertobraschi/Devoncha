...
{
	include_once(TEMPLATEPATH . '/library/includes/affiliates/export_report_user.php');
}else
{
	include_once(TEMPLATEPATH . '/library/includes/affiliates/export_report_month.php');	
}?>
<?php
