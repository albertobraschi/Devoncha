...
if(CHILDTEMPLATEPATH && file_exists(CHILDTEMPLATEPATH . '/return_page.php'))
{
	$middle_content_file_fullpath = CHILDTEMPLATEPATH . '/return_page.php';
}else{
	$middle_content_file_fullpath = TEMPLATEPATH . "/library/includes/return_page.php";
}
