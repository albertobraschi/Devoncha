...
$api_username = $paymentOpts['api_username'];
$api_password = $paymentOpts['api_password'];
$api_signature = $paymentOpts['api_signature'];
...
/* Define the PayPal URL. This is the URL that the buyer is
   ...
   */
//define('PAYPAL_URL', 'https://beta-sandbox.paypal.com/webscr&cmd=_express-checkout&token=');
