...
function mytheme_admin_head() { 
  if ('admin.php' == basename($_SERVER['SCRIPT_FILENAME'])) {
	/*echo '<link rel="stylesheet" type="text/css" href="'.get_bloginfo('template_directory').'/admin/css/style.css" media="screen" />';
	echo '<script type="text/javascript" src="'.get_bloginfo('template_directory').'/admin/js/ptthemes.js"></script>';
	echo '<script type="text/javascript" src="'.get_bloginfo('template_directory').'/admin/js/jquery-ui.js"></script>';
	echo '<script type="text/javascript" src="'.get_bloginfo('template_directory').'/admin/js/taber.js"></script>';*/
...
{
	$alt_stylesheet_path = CHILDTEMPLATEPATH . '/skins/';
}else
{
...
function get_categories_array()
{
	...
	{
		foreach ($cats as $cat) {	
				$return_array[] = array(	"id" => $cat->cat_ID,
							   "title"=> $cat->name,);
		}
	}
	return $return_array;
