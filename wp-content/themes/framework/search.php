...
if(CHILDTEMPLATEPATH && file_exists(CHILDTEMPLATEPATH . '/search_page.php'))
{
	$middle_content_file_fullpath = CHILDTEMPLATEPATH . '/search_page.php';
}else{
	$middle_content_file_fullpath = TEMPLATEPATH . "/library/includes/search_page.php";
}
